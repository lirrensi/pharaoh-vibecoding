...
Update the affected documentation layers: `docs/product.md`, `docs/spec.md`, and `docs/arch*.md`. Show each diff - present changes summary, ask for confirmation, then save.
...
- Plans save to `.agents/reports/plan_{short-name}_{yyyy-mm-dd}.md`, Briefs save to `.agents/reports/brief_{short-name}_{yyyy-mm-dd}.md`
